...
| اقتراحات الأحداث | منفّذة ومختبرة محلياً: بحث في الويب عن أحداث المحاور والرائج العام في خطة الأحد ونشرة الأربعاء، مع رابط المصدر (`NOTES.md` القسم 11) |
...
| `/plan` | 3 موضوعات مقترحة (تستفيد من آخر مقاييس، ولا تبحث في الويب) |
...
- الأحد 8:00 ص: خطة الأسبوع، ومعها اقتراح أو اثنان من أحداث الأسبوع برابط المصدر.
- الأربعاء 8:00 ص: نشرة أحداث منتصف الأسبوع، اقتراحات من الأحداث وحدها.
...
### 3. Anthropic
أنشئ مفتاح API من Console، وضع حداً شهرياً للإنفاق. البحث في الويب، الذي تعتمد عليه اقتراحات الأحداث، مفعّل افتراضياً؛ لا تعطّله من Console ← Settings ← Privacy.
...
src/events.ts           بحث الويب عن الأحداث لخطة الأحد ونشرة الأربعاء
...
src/prompts/            classify · draft · revise · plan · events · report · shared
